...
class _DashboardPageState extends State<DashboardPage> {
  ...
  /// ================= TIMER =================
  Timer? _timer;
  int sisaMenit = 0; // 🔄 DIUBAH: sisaDetik -> sisaMenit
  ...
  Future<void> _tryStartTimer() async {
    ...
    setState(() {
      sisaMenit = durasi; // 🔄 DIUBAH: Menyimpan langsung dalam satuan menit
    });

    // 🔄 DIUBAH: Berjalan periodik setiap 1 menit (bukan 1 detik lagi)
    _timer = Timer.periodic(const Duration(minutes: 1), (timer) async {
      if (sisaMenit <= 0) {
        ...
        setState(() {
          sisaMenit--; // 🔄 DIUBAH: Mengurangi sisa waktu menit
        });
      }
    });
  }
  ...
  /// ================= FORMAT TIMER =================
  // 🔄 DIUBAH: Mengembalikan format string dengan label "Menit" langsung
  String formatTimer(int menit) {
    return '$menit Menit';
  }
  ...
  Future<void> emergencyCutOff() async {
    ...
    setState(() {
      sisaMenit = 0; // 🔄 DIUBAH: reset ke 0 menit
    });
            ...
            SizedBox(
              ...
              child: isLoading
                ...
                style: TextStyle(
                  ...
                  : (sisaMenit != 0 // 🔄 DIUBAH: Menggunakan sisaMenit
                  ? Text(
                'Sisa waktu: ${formatTimer(sisaMenit)}',
